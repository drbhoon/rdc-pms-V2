...
const ACTION_COLORS = {
  ...
  HR_SPOC_SUBMITTED: 'bg-teal-100   text-teal-700   border-teal-200',
  HR_HEAD_SUBMITTED: 'bg-violet-100 text-violet-700 border-violet-200',
  COTO_SUBMITTED:    'bg-rose-100   text-rose-700   border-rose-200',
